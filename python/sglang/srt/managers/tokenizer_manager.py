    ...
    def _create_tokenized_object(
        ...
        if isinstance(obj, GenerateReqInput):
            ...
            tokenized_obj = TokenizedGenerateReqInput(
                ...
                prefill_ttft_slo_ms=obj.prefill_ttft_slo_ms,
                prefill_deadline_ts=obj.prefill_deadline_ts,
                prefill_slack=obj.prefill_slack,
                prefill_predicted_remaining_time=obj.prefill_predicted_remaining_time,
